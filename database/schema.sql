...
CREATE TABLE IF NOT EXISTS `film_director` (
    ...
    FOREIGN KEY(`director_id`) REFERENCES `person`(`id`)
        ON DELETE CASCADE                                           -- Deleting a director will remove its film associations
);
...
CREATE TABLE IF NOT EXISTS `film_actor` (
    ...
    FOREIGN KEY(`film_id`) REFERENCES `film`(`id`)
        ON DELETE CASCADE,                                          -- Deleting a film removes its actor associations

    FOREIGN KEY(`actor_id`) REFERENCES `person`(`id`)
        ON DELETE CASCADE                                           -- Deleting an actor removes its film associations
);
...
CREATE TABLE IF NOT EXISTS `evaluation` (
    ...
    FOREIGN KEY(`judge_id`) REFERENCES `staff`(`id`)
        ON DELETE CASCADE,                                          -- Deleting a judge removes its evaluations

    FOREIGN KEY(`film_id`) REFERENCES `film`(`id`)
        ON DELETE CASCADE                                           -- Deleting a film removes its evaluations
);
...
CREATE TABLE IF NOT EXISTS `festival_film` (
    ...
    FOREIGN KEY (`festival_id`) REFERENCES `festival`(`id`)
        ON DELETE CASCADE,                                          -- Deleting a festival removes its film associations

    FOREIGN KEY (`film_id`) REFERENCES `film`(`id`)
        ON DELETE CASCADE                                           -- Deleting a film removes its festival associations
);
